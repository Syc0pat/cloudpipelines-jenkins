...
cp ~/.minikube/profiles/minikube/apiserver.crt seed/k8s/ || echo "Failed to copy Kubernetes client certificate file"
cp ~/.minikube/profiles/minikube/apiserver.key seed/k8s/ || echo "Failed to copy Kubernetes client key file"
